"""
BƯỚC 4: TRAIN NEURAL NETWORK (PYTORCH)
Biến dữ liệu self-play thành "trí nhớ" của AI
"""
...
def full_training_pipeline(output_dir: str = './models'):
    """
    ...
    # BƯỚC 1: Self-play để tạo training data
    print("=" * 50)
