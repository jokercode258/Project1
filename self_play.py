"""
BƯỚC 2: SELF-PLAY (TẠO DỮ LIỆU TRAIN)
AI tự chơi với chính nó, ghi lại trạng thái và kết quả
"""
...
from minimax_engine import RandomEngine, MinimaxEngine
...
class SelfPlayGame:
    """
    Một trận self-play giữa hai engine
    """
...
if __name__ == "__main__":
    ...
    # Trước tiên test với random engines
    print("1. Random vs Random (10 games)")
    manager = SelfPlayManager()
    stats = manager.play_games(num_games=10, white_mode='random', black_mode='random', max_moves=50)
    
    print(f"\nStats:")
    print(f"  Tổng game: {stats['total_games']}")
